LicensePlateLocation MATLAB Java Package
...
- LicensePlateLocation.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for LicensePlateLocation is in the doc directory. When  
